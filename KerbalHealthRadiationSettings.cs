...
namespace KerbalHealth
{
    ...
    public override void SetDifficultyPreset(GameParameters.Preset preset)
    {
        ...
        [GameParameters.CustomFloatParameterUI("#KH_RS_SolarRadiation", toolTip = "#KH_RS_SolarRadiation_desc", minValue = 0, maxValue = 10000, displayFormat = "N0", stepCount = 21)]//Solar Radiation (Nominal)""Solar radiation in interplanetary space at 1 AU, banana doses/day
