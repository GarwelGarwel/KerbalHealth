namespace KerbalHealth
{
    class KerbalHealthEventsSettings : GameParameters.CustomParameterNode
    {
        ...
        [GameParameters.CustomParameterUI("Conditions Can Appear", toolTip = "If checked, health conditions can randomly appear in kerbals; existing conditions will still develop")]
